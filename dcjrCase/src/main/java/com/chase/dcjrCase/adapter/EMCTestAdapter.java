...
public class EMCTestAdapter extends BaseAdapter {
    private ArrayList<TestEMCdataBean> mList;
    private Context mContext;
    private int mCount;



    public EMCTestAdapter(Activity mActivity, ArrayList<TestEMCdataBean> mTestEMCList) {
        this.mList = mTestEMCList;
        this.mContext = mActivity;
    }

    @Override
    public int getCount() {
        mCount = HomeEMCTestFragment.getCount();
        System.out.println("mList.size():"+mList.size()+" "+"mCount:"+HomeEMCTestFragment.getCount());
    ...
    @Override
    public TestEMCdataBean getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TestEMCdataBean item = mList.get(position);

        if (convertView == null) {
            switch (type) {
                case 1:
                    convertView = View.inflate(mContext, R.layout.item_emc_test_type1_list, null);
                    holder1 = new ViewHolder1(convertView);
                    convertView.setTag(holder1);

                    break;
                case 2:
                    convertView = View.inflate(mContext, R.layout.item_emc_test_type2_list, null);
 ...
 /*
    ...
    class ViewHolder1 {
        ...
        public ViewHolder1(View view) {
            iv_image = view.findViewById(R.id.iv_emc_test_image);
            tv_title = view.findViewById(R.id.tv_emc_test_title);
            tv_date = view.findViewById(R.id.tv_emc_test_date);
            tv_from = view.findViewById(R.id.tv_emc_test_from);
        }
    }
    ...
    class ViewHolder2 {
        ...
        public ViewHolder2(View view) {
            tv_emc_title = view.findViewById(R.id.tv_emc_test_title);
            iv_emc_image1 = view.findViewById(R.id.iv_emc_test_image1);
            iv_emc_image2 = view.findViewById(R.id.iv_emc_test_image2);
            iv_emc_image3 = view.findViewById(R.id.iv_emc_test_image3);
            tv_emc_from = view.findViewById(R.id.tv_emc_test_from);
            tv_emc_author = view.findViewById(R.id.tv_emc_test_author);
            tv_emc_date = view.findViewById(R.id.tv_emc_test_date);
        }
    }
}
