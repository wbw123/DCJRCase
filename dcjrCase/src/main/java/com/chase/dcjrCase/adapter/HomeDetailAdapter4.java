...
public class HomeDetailAdapter4 extends BaseAdapter {
    private ArrayList<String> mListItems;
    private Context mContext;


    public HomeDetailAdapter4(Activity mActivity, ArrayList<String> listItems) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = View.inflate(mContext, R.layout.item_home_detail4_list, null);
