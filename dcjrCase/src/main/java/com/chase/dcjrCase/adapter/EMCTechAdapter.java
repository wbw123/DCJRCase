...
public class EMCTechAdapter extends BaseAdapter {
    private ArrayList<TechEMCdataBean> mList;
    private Context mContext;
    private int mCount;

    public EMCTechAdapter(Activity mActivity, ArrayList<TechEMCdataBean> mTechEMCList) {
        this.mList = mTechEMCList;
        this.mContext = mActivity;
    }

    @Override
    public int getCount() {
        System.out.println("EMCTechAdapter getCount");
        mCount = HomeEMCTechFragment.getCount();
    ...
    @Override
    public TechEMCdataBean getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        System.out.println("EMCTechAdapter getView");
        ViewHolder1 holder1 = null;
        ViewHolder2 holder2 = null;

        int type = getItemViewType(position);
        TechEMCdataBean item = mList.get(position);

        if (convertView == null) {
            switch (type) {
                case 1:
                    convertView = View.inflate(mContext, R.layout.item_emc_tech_type1_list, null);
                    holder1 = new ViewHolder1(convertView);
                    convertView.setTag(holder1);

                    break;
                case 2:
                    convertView = View.inflate(mContext, R.layout.item_emc_tech_type2_list, null);
...
//                .fitCenter()//指定图片缩放类型为fitCenter
    ...
    class ViewHolder1 {
        ...
        public ViewHolder1(View view) {
            iv_image = view.findViewById(R.id.iv_emc_tech_image);
            tv_title = view.findViewById(R.id.tv_emc_tech_title);
            tv_date = view.findViewById(R.id.tv_emc_tech_date);
            tv_from = view.findViewById(R.id.tv_emc_tech_from);
        }
    }
    ...
    class ViewHolder2 {
        ...
        public ViewHolder2(View view) {
            tv_emc_title = view.findViewById(R.id.tv_emc_tech_title);
            iv_emc_image1 = view.findViewById(R.id.iv_emc_tech_image1);
            iv_emc_image2 = view.findViewById(R.id.iv_emc_tech_image2);
            iv_emc_image3 = view.findViewById(R.id.iv_emc_tech_image3);
            tv_emc_from = view.findViewById(R.id.tv_emc_tech_from);
            tv_emc_author = view.findViewById(R.id.tv_emc_tech_author);
            tv_emc_date = view.findViewById(R.id.tv_emc_tech_date);
        }
    }
}
